...
TEMPLATES = [
    TemplateResponse(type="invoice", name="Invoice", description="Commercial invoices with line items, totals, and vendor info",
    ...
    TemplateResponse(type="receipt", name="Receipt", description="Purchase receipts with itemized costs",
        required_fields=["date", "total_amount", "merchant_name"],
        optional_fields=["tax_amount", "payment_method", "line_items"]),
    TemplateResponse(type="medical_report", name="Medical Report", description="Medical lab reports and diagnostic documents",
        required_fields=["patient_name", "report_date", "report_type"],
        optional_fields=["doctor_name", "diagnosis", "test_results", "facility"]),
    TemplateResponse(type="contract", name="Contract", description="Legal contracts and agreements",
        required_fields=["parties", "effective_date", "contract_type"],
        optional_fields=["expiry_date", "terms", "signatures", "governing_law"]),
    TemplateResponse(type="id_document", name="ID Document", description="Government-issued identification documents",
